...
.macro put_char c, i = positionOnLine # character, index
...
.macro put_string s, i = positionOnLine # string pointer, index  
    push %edx
    push %esi
...
.macro put_int_single n, i = positionOnLine # number, index
    push %edx
    push %esi
